...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      KC_LCTL, KC_LGUI, KC_LALT, LT(_FNL, KC_SPC), LT(_FNR, KC_SPC), XXXXXXX, XXXXXXX, XXXXXXX\
      ),
  [_FNL] = LAYOUT( \
      _______, _______, KC_KP_ASTERISK, KC_KP_MINUS,KC_7,    KC_8,   KC_9, _______, _______, _______, KC_EQUAL, KC_MINUS, \
      _______, _______,   KC_KP_SLASH,   KC_KP_PLUS,  KC_4,  KC_5,  KC_6, _______, KC_LBRACKET, KC_RBRACKET, KC_BSLASH, \
      _______,   _______,   KC_KP_DOT,      KC_0,     KC_1,  KC_2,  KC_3, KC_SCOLON, KC_QUOTE, KC_UP, _______, \
      RESET, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_RIGHT \
      ),
  [_FNR] = LAYOUT( \
